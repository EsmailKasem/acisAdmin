...
namespace FrameWork
{
    ...
    public class ValidateCompare : BusinessRule
    {
        ...
        public ValidateCompare(string propertyNameEn, string otherPropertyNameEn, ValidationOperator @operator, ValidationDataType dataType)
            : base(propertyNameEn)
        {

            Operator = @operator;
            DataType = dataType;
            OtherPropertyName = otherPropertyNameEn;
            ErrorMessage_En = propertyNameEn + " must be " + Operator.ToString() + " than " + otherPropertyNameEn;

        }

        public ValidateCompare(string propertyNameEn,  string otherPropertyNameEn, string errorMessageAr, string errorMessageEn,
            ValidationOperator @operator, ValidationDataType dataType)
            : this(propertyNameEn,  otherPropertyNameEn, @operator, dataType)
        {
