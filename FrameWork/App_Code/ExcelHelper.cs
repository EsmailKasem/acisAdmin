...
namespace FrameWork
{
    class ExcelXMLExportHelper
    {
        ...
        public static void ToFormattedExcel(DataTable dtInput, string filename)
        {
            // we get the xml headers first
            string excelTemplate = getXMLWorkbookTemplate();
            ...
            tablas += GetExcelTableXml(dtInput, true);
        ...
        public static void ToFormattedExcel<T>(IList<T> ListInput, string filename)
        {
            ...
            ToFormattedExcel(table, filename);
        }
