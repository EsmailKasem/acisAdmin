...
namespace FrameWork
{
    ...
    public class ValidateRange : BusinessRule
    {
        ...
        public ValidateRange( string propertyNameEn, object min, object max,
            ...
            : base( propertyNameEn)
        {
            ...
            ErrorMessage_En = propertyNameEn + " must be between " + Min + " and " + Max;
        }

        public ValidateRange(string propertyNameEn, string errorMessageAr, string errorMessageEn, object min, object max,
            ValidationOperator @operator, ValidationDataType dataType)
            : this(propertyNameEn, min, max, @operator, dataType)
        {
